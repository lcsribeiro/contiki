...
#define IINCHIP_ISR_DISABLE()   ti_lib_int_master_disable(); //__disable_interrupt()
#define IINCHIP_ISR_ENABLE()    ti_lib_int_master_enable();  //__enable_interrupt()
...
// Reserved			                     (0x001D)    //#define WIZC_PMAGIC                      (0x001D)    /** @brief PPP LCP Magic number register  in PPPoE mode */
#define WIZC_PDHA0                       (0x001E)    /** @brief PPP Destination MAC Register address */
...
#define WIZC_PHYCFG                     (0x002E)    /** @brief PHY Status Register */

/** @brief PHY Status Register Bit*/
#define WIZC_PHYCFG_RESET               (7)
#define WIZC_PHYCFG_MODEEN              (6)
#define WIZC_PHYCFG_MODE2               (5)
#define WIZC_PHYCFG_MODE1               (4)
#define WIZC_PHYCFG_MODE0               (3)
#define WIZC_PHYCFG_LEDDUP              (2)
#define WIZC_PHYCFG_LEDSPD              (1)
#define WIZC_PHYCFG_LEDLNK              (0)
...
void IINCHIP_WRITE_COMMON_SEQB(uint16 addr, uint8 len, uint8 * data, uint8 byte_en );
void IINCHIP_READ_COMMON_SEQB(uint16 addr, uint8 len, uint8 * data, uint8 byte_en );
...
void IINCHIP_READ_DM_SEQ(uint16 addr,  uint16 len, uint8 * data);
void IINCHIP_WRITE_DM_SEQ( uint16 addr,  uint16 len, uint8 *data);
